...
like($yaml, qr/AUTHOR_TESTING=1\s+prove\s+dist\/Net-Blossom\/xt\s+dist\/Net-Blossom-Server\/xt\s+dist\/Net-Blossom-Server-Backend-SQLite\/xt/,
...
like($yaml, qr/COVERAGE_TESTING=1\s+AUTHOR_TESTING=1\s+prove\s+dist\/Net-Blossom\/xt\/06-author-coverage\.t\s+dist\/Net-Blossom-Server\/xt\/05-author-coverage\.t\s+dist\/Net-Blossom-Server-Backend-SQLite\/xt\/04-author-coverage\.t/,
